  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="py-24 px-4 bg-gradient-to-b from-background to-background/50">
        <div className="max-w-6xl mx-auto space-y-16">
          <div className="text-center space-y-4">
            <h2 className="text-3xl md:text-4xl font-bold">What Others Are Saying</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                quote: "This assessment helped me understand my unique calling and how to serve effectively in my church.",
                author: "Sarah M.",
                role: "Ministry Leader"
              },
              {
                quote: "The AI-powered insights were incredibly accurate and gave me practical ways to use my gifts.",
                author: "David R.",
                role: "Church Elder"
              },
              {
                quote: "Finally, a spiritual gifts test that's both biblically sound and technologically advanced!",
                author: "Rachel T.",
                role: "Youth Pastor"
              }
            ].map((testimonial, i) => (
